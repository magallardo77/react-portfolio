...
const Contact = () => {
  return (
    <div>
        <h2 className="m-4 text-[45px] font-sans font-extrabold text-center text-blue-300 p-5">Contact Me</h2>
          <p className="block text-center text-[25px] mb-2 font-bold font-sans text-sky-600"> Email: magallardo77@outlook.com</p>
          <p className="block text-center text-[25px] mb-2 font-bold font-sans text-sky-600"> Phone: 602-349-3318</p>
    </div>
