...
const Contact = () => {
  return (
    <div className='contactContainer '>
      ...
      <h2 class="m-4 text-[35px] font-extrabold text-center text-blue-300 p-5">Contact Us</h2>
      <p class="mb-8 lg:mb-16 font-light text-center text-sky-600 sm:text-xl">Got a technical issue? Want to send feedback about a beta feature? Need details about our Business plan? Let us know.</p>
      <form action="#" class="space-y-8">
          <div>
              <label for="email" class="block mb-2 text-sm font-medium text-sky-600">Your email</label>
          ...
          <div>
              <label for="subject" class="block mb-2 text-sm font-medium text-sky-600">Subject</label>
          ...
          <div class="sm:col-span-2">
              <label for="message" class="block mb-2 text-sm font-medium text-sky-600">Your message</label>
